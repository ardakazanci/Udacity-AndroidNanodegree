...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        // TODO (COMPLETED) Register the listener

        sharedPreferences.registerOnSharedPreferenceChangeListener(this);
    }

    // TODO (COMPLETED) Override the onSharedPreferenceChanged method and update the show bass preference
    // TODO (COMPLETED) Override onDestroy and unregister the listener
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        // Hangi tercihin değiştiğini kontrol ediyoruz.
