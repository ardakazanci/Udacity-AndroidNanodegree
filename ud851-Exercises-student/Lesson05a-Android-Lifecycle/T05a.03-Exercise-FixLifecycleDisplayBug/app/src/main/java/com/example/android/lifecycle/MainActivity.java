...
public class MainActivity extends AppCompatActivity {
    ...
    private static ArrayList<String> lifecycleInfoList = new ArrayList<>();
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i = lifecycleInfoList.size()-1; i >= 0; i-- ){
            mLifecycleDisplay.append(lifecycleInfoList.get(i)+"\n");
        }

        // TODO (COMPLETED) Clear mLifecycleCallbacks after iterating through it
        lifecycleInfoList.clear();
    ...
    protected void onDestroy() {
        ...
        lifecycleInfoList.add(ON_DESTROY);
