...
public class VisualizerActivity extends AppCompatActivity {
    ...
    // TODO (COMPLETED) Change the name of default setup to setupSharedPreferences
    private void setupSharedPreferences() {
        // TODO (COMPLETED) Get a reference to the default shared preferences from the PreferenceManager class
        // TODO (COMPLETED) Get the value of the show_bass checkbox preference and use it to call setShowBass
