...
public class VisualizerActivity extends AppCompatActivity {
    ...
    private void defaultSetup() {
        mVisualizerView.setShowBass(true); // Daire
        mVisualizerView.setShowMid(false);
        mVisualizerView.setShowTreble(true); // Üçgen
    ...
    private void setupPermissions() {
        // Eğer ses kaydı iznimiz yoksa
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED) {
            // Eğer SDK M veya sonrasıysa
    ...
    // TODO (COMPLETED) Create a new Empty Activity named SettingsActivity; make sure to generate the
    // activity_settings.xml layout file as well and add the activity to the manifest

    // TODO (COMPLETED) Add a new resource folder called menu and create visualizer_menu.xml
    // TODO (COMPLETED) In visualizer_menu.xml create a menu item with a single item. The id should be
    ...
    // TODO (COMPLETED) Add the menu to the menu bar
    // TODO (COMPLETED) When the "Settings" menu item is pressed, open SettingsActivity
